...
```
(npm run sync; cd site; vendor/bin/phpunit tests/unit/Espo/Modules/GroupMention)
```
...
```
(npm run sync; cd site; vendor/bin/phpunit tests/integration/Espo/Modules/GroupMention)
```
...
If your extension contains additional PHP packages, you also need to add `site/custom/Espo/Modules/GroupMention/vendor` to the *scanDirectories* section in *phpstan.neon* config.
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/GroupMention`
* `site/tests/integration/Espo/Modules/GroupMention`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/GroupMention/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/GroupMention/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/group-mention/lib/init.js"
        ]
    }
    ```
...
Add the library module path to `src/files/custom/Espo/Modules/GroupMention/Resources/metadata/app/jsLibs.json`

```json
{
    "some-lib": {
        "path": "client/custom/modules/group-mention/lib/some-lib.js"
    }
}
```
