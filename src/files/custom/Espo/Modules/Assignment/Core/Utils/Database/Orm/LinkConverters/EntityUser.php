...
namespace Espo\Modules\Assignment\Core\Utils\Database\Orm\LinkConverters;
        ...
        return EntityDefs::create()
            ->withRelation(
                RelationDefs::create($name)
                    ...
                    ->withAdditionalColumn(
                        AttributeDefs::create('role')
                            ->withType(AttributeType::VARCHAR)
                            ->withLength(self::ENTITY_TYPE_LENGTH)
                    )
                    ->withAdditionalColumn(
                        AttributeDefs::create('roleId')
                            ->withType(AttributeType::VARCHAR)
                            ->withLength(self::ENTITY_TYPE_LENGTH)
                    )
                    ->withAdditionalColumn(
                        AttributeDefs::create('synced')
